...
This has to do with the hierarchy of sizes of infinite sets. If you're interested, there is a document with the lecture materials you can read.
...
* If $A_1,A_2,A_3,\ldots$ are disjoint and 
$$\bigcup\limits_{i=1}^\infty A_i = S$$
we say it is a *partition* of $S$.
